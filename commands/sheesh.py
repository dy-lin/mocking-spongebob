...
class Sheesh(BaseCommand):

    def __init__(self):
        # A quick description for the help message
        description = "Sends Sheesh"
    ...
    async def handle(self, params, message, client):
        ...
        num = randint(2,8)
        e = ":regional_indicator_e: " * num 
        msg = ":regional_indicator_s: :regional_indicator_h: " + e + ":regional_indicator_s: :regional_indicator_h: :exclamation:" 
