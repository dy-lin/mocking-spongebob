...
class Unfix(BaseCommand):

    def __init__(self):
        # A quick description for the help message
        description = "Resets adjacent i's and L's to default behaviour" 
    ...
    async def handle(self, params, message, client):
        ...
        os.environ["FIXL"] = "False"
        await message.channel.send("Reset adjacent i's and L's to default behaviour.")
