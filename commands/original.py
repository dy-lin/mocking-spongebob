...
class Original(BaseCommand):

    def __init__(self):
        # A quick description for the help message
        description = "Sends original link in addition to embeded one"
    ...
    async def handle(self, params, message, client):
        ...
        if params[0].lower() == "on":
            f = open("C:/Users/Diana/mocking-spongebob/files/original", "w")
            f.write("on")
            f.close()
            ...
            await message.channel.send("!alternate should be used with <on> or <off>.")
