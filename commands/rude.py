...
class Rude(BaseCommand):

    def __init__(self):
        # A quick description for the help message
        description = "Sends RUDE"
    ...
    async def handle(self, params, message, client):
        ...
        await message.channel.send(":regional_indicator_r: :regional_indicator_u: :regional_indicator_d: :regional_indicator_e:")
