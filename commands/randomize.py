...
class Randomize(BaseCommand):

    def __init__(self):
        # A quick description for the help message
        description = "Randomizes upper and lower case letters"
    ...
    async def handle(self, params, message, client):
        ...
        os.environ["RANDOMIZE"] = "True"
        await message.channel.send("Upper and lowercase letters have been randomized.")
